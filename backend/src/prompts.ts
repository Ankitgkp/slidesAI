...
- User's Original Request: ${userPromot}
- Current Date: ${currentDate}
- Language: ${userLanguage}
- Total Slides: ${noOfSlies}
...
## CRITICAL RULES
1. Generate exactly ${noOfSlies} slides. NOT MORE NOT LESS ! EXACTLY ${noOfSlies}
...
Now create a complete XML presentation with ${noOfSlies} slides that significantly expands on the outline.
`